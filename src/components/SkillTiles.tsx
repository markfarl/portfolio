      ...
      <section className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4  gap-3 mt-10">
        ...
        {skillArray.map((element, idx) => {
          return (<Link key={`id_${idx}`} to={element.href}>
            <div className={`transform transition duration-200 hover:scale-105 hover:animate-pulse border-4 w-full h-0 pb-full ${colorSchemeClass.borderLine} main-tiles ${colorSchemeClass.tilesBk}`}>
