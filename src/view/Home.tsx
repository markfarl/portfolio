...
import { socialIconStyle } from "@/constants/styleClasses"
import { Link, useParams } from "react-router-dom"


export default function Home() {
  const { skill } = useParams<string>()
        ...
        {skill && (
          <div className="container md:mx-auto max-w-screen-xl p-16 xl:p-0">
            <section className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4  grid-rows-2 gap-3 mt-10">
              ...
              <div className="transform transition duration-200 hover:scale-105 border-4 w-full row-span-2 col-span-3 border-cyan-line main-tiles bg-main-tiles"></div>
            </section>
          </div>
        )
        }
