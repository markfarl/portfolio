  ...
  return (
    <>
      <header className="container md:mx-auto max-w-screen-xl bg-header-bk bg-left">
        <div className="grid md:grid-cols-3 items-start">
          ...
          <div className="grid md:col-span-2 pl-5 xl:pl-0">
            <div className="border-b-4  border-cyan-line">
              <h1 className="font-bold font-Heavitas">
                Mark Farrell.
              </h1>
            </div>
            <div className="h-80px">
              <h2 className="font-Heavitas mt-3 ">
                Software Engineer
              </h2>
            </div>
            <div className="md:w-10/12">
              <p className="mt-3">Software Engineer with over 10 years industry experience.
                I build out web applications using frameworks and libraries such as React, Typescript, Vite & Vitest as well as developing endpoints and integration with cloud applications.</p>
        ...
        <div className="md:col-span-3 pt-5 pb-5 pl-5 xl:pl-0">
      ...
      <main className="border-t-4 pb-10 border-cyan-line bg-main-content">
        <div className="container md:mx-auto max-w-screen-xl p-5 xl:p-0">
          <section className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4  gap-2 mt-10">
            <div className="border-4 w-full h-0 pb-full  border-cyan-line main-tiles bg-main-tiles"></div>
            <div className="border-4 w-full h-0 pb-full  border-cyan-line main-tiles bg-main-tiles"></div>
            <div className="border-4 w-full h-0 pb-full  border-cyan-line main-tiles bg-main-tiles"></div>
            <div className="border-4 w-full h-0 pb-full  border-cyan-line main-tiles bg-main-tiles"></div>
            <div className="border-4 w-full h-0 pb-full  border-cyan-line main-tiles bg-main-tiles"></div>
