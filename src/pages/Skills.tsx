      ...
      <main className={`transform transition duration-200 border-t-4 pb-10 ${colorSchemeClass.borderLine} ${colorSchemeClass.mainContent}`}>
        ...
        <div className="container md:mx-auto max-w-screen-xl p-8 xl:p-0">
          <section id="topRef" className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 lg:grid-rows-2 gap-3 mt-10">
            <Link to={`/`}>
              <div className={`transform transition duration-200 hover:scale-105 border-4 sm:w-full h-0 pb-full ${colorSchemeClass.borderLine} main-tiles ${colorSchemeClass.tilesBk}`}>
            ...
            <div className={`transform transition duration-200 border-4 row-span-3 sm:col-span-3 ${colorSchemeClass.borderLine} main-tiles ${colorSchemeClass.tilesBk}`}>
              <Outlet />
            </div>
          </section>
